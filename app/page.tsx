  ...
  return (
    <div className="min-h-screen p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <Head>
        ...
        <meta name="description" content="CV de Ethan Legris" />
      ...
      <main className="flex flex-col items-center gap-8 max-w-3xl mx-auto text-center">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p className="text-lg text-white-600">Étudiant de 1ère année à <span className="text-yellow-300">Enigma</span></p>
        </section>
        ...
        <section className="flex flex-col items-start">
          ...
          <p className="text-lg text-customgray"><span className="text-yellow-200">Brevet des collèges :</span> Mention Bien</p>
        </section>
        ...
        <section className="flex flex-col gap-6 items-center">
          <div className="flex flex-col items-center">
            <p className="text-lg text-red-300"><span className="text-white">Anglais :</span> Niveau C1</p>
            <div className="w-64 bg-gray-200 h-2">
              <div className="bg-yellow-500 h-2" style={{ width: '85%' }}></div>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-lg text-red-300"><span className="text-white">Allemand :</span> Niveau A2</p>
            <div className="w-64 bg-gray-200 h-2">
              <div className="bg-yellow-500 h-2" style={{ width: '30%' }}></div>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-lg text-red-300"><span className="text-white">Développement Web :</span> Intermédiaire</p>
            <div className="w-64 bg-gray-200 h-2">
              <div className="bg-yellow-500 h-2" style={{ width: '60%' }}></div>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-lg text-red-300"><span className="text-white">Adobe Creative Cloud :</span> Intermédiaire</p>
            <div className="w-64 bg-gray-200 h-2">
              <div className="bg-yellow-500 h-2" style={{ width: '60%' }}></div>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-lg text-red-300"><span className="text-white">Création 3D :</span> Avancé</p>
            <div className="w-64 bg-gray-200 h-2">
        ...
        <section className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <h1 className="font-bold text-2xl">Cassel Paintball Park (2023) <span className="font-bold text-blue-300 text-sm">(Entreprise multi-loisirs)</span> :</h1>
          </div>
          <br />
          <p><span className="text-xl text-blue-300">Relations Clients : </span>Accueil et gestion des besoins liés aux clients.</p>
          <p><span className="text-xl text-blue-300">Animation : </span>Savoir animer des groupes de personne durant des activités.</p>
          <br />
          <hr className="border-t border-blue-300 w-full" />
          ...
          <div className="flex items-center gap-4">
            <Image 
              ...
              className="object-contain rounded-full shadow-md"
            />
            <h1 className="font-bold text-2xl">Diamand's Car (2022) <span className="font-bold text-blue-300 text-sm">(Entreprise d'entretien automobile)</span> :</h1>
          </div>
          <br />
          <p><span className="text-xl text-blue-300">Gestion des stocks : </span>Gestion des stocks du garage et de la boutique.</p>
          <p><span className="text-xl text-blue-300">Préparation de commande : </span>Préparation des commandes des clients en ligne.</p>
          <br />
          <hr className="border-t border-blue-300 w-full" />
          <br />
        </section>
        ...
        <section className="flex flex-col items-start">
          <div className="items-center">
            <h1 className="text-2xl text-green-300">Photographie :</h1>
            <p>
          ...
          <br />
          <div className="items-center">
            <h1 className="text-2xl text-green-300">Modélisation 3D :</h1>
            <p>
